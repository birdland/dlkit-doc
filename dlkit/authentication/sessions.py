...
class AgentQuerySession(osid_sessions.OsidSession):
...
class AgentSearchSession(AgentQuerySession):
    """This session provides methods for searching ``Agents``.
...
class AgentAdminSession(osid_sessions.OsidSession):
...
class AgentNotificationSession(osid_sessions.OsidSession):
...
class AgentAgencySession(osid_sessions.OsidSession):
...
class AgentAgencyAssignmentSession(osid_sessions.OsidSession):
...
class AgencyLookupSession(osid_sessions.OsidSession):
...
class AgencyQuerySession(osid_sessions.OsidSession):
...
class AgencySearchSession(AgencyQuerySession):
    """This session provides methods for searching among ``Agency`` objects.
...
class AgencyAdminSession(osid_sessions.OsidSession):
...
class AgencyNotificationSession(osid_sessions.OsidSession):
...
class AgencyHierarchySession(osid_sessions.OsidSession):
...
class AgencyHierarchyDesignSession(osid_sessions.OsidSession):
