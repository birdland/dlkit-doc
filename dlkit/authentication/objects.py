...
class Agency(osid_objects.OsidCatalog):
...
class AgencyForm(osid_objects.OsidCatalogForm):
...
class AgencyNode(osid_objects.OsidNode):
...
class AgencyNodeList(osid_objects.OsidList):
