...
class MyAssessmentTakenSession(osid_sessions.OsidSession):
...
class ItemSmartBankSession(osid_sessions.OsidSession):
...
class AssessmentSearchSession(AssessmentQuerySession):
...
class AssessmentNotificationSession(osid_sessions.OsidSession):
...
class AssessmentSmartBankSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic catalogs.
...
class AssessmentOfferedSearchSession(AssessmentOfferedQuerySession):
...
class AssessmentOfferedNotificationSession(osid_sessions.OsidSession):
...
class AssessmentOfferedSmartBankSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic catalogs.
...
class AssessmentTakenSearchSession(AssessmentTakenQuerySession):
    """This session provides methods for searching among ``AssessmentTaken`` objects.
...
class AssessmentTakenNotificationSession(osid_sessions.OsidSession):
...
class AssessmentTakenSmartBankSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic catalogs.
...
class BankSearchSession(BankQuerySession):
    """This session provides methods for searching among ``Bank`` objects.
...
class BankNotificationSession(osid_sessions.OsidSession):
