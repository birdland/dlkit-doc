...
class QuestionQueryInspector(osid_query_inspectors.OsidObjectQueryInspector):
...
class AnswerQueryInspector(osid_query_inspectors.OsidObjectQueryInspector):
    """The query inspectors provide a means of accessing the match terms of a query.
...
class AssessmentQueryInspector(osid_query_inspectors.OsidObjectQueryInspector):
    """The query inspectors provide a means of accessing the match terms of a query.
...
class AssessmentOfferedQueryInspector(osid_query_inspectors.OsidObjectQueryInspector, osid_query_inspectors.OsidSubjugateableQueryInspector):
    """The query inspectors provide a means of accessing the match terms of a query.
...
class AssessmentTakenQueryInspector(osid_query_inspectors.OsidObjectQueryInspector):
    """The query inspectors provide a means of accessing the match terms of a query.
...
class BankQueryInspector(osid_query_inspectors.OsidCatalogQueryInspector):
    """The query inspectors provide a means of accessing the match terms of a query.
