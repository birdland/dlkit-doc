...
class ValueRetrievalSession(osid_sessions.OsidSession):
...
class ValueLookupSession(ValueRetrievalSession):
...
class ValueQuerySession(osid_sessions.OsidSession):
...
class ValueSearchSession(ValueQuerySession):
    """This session provides methods for searching ``Value`` objects.
...
class ValueAdminSession(osid_sessions.OsidSession):
...
class ValueNotificationSession(osid_sessions.OsidSession):
...
class ParameterLookupSession(osid_sessions.OsidSession):
...
class ParameterQuerySession(osid_sessions.OsidSession):
...
class ParameterSearchSession(ParameterQuerySession):
    """This session provides methods for searching ``Parameter`` objects.
...
class ParameterAdminSession(osid_sessions.OsidSession):
...
class ParameterNotificationSession(osid_sessions.OsidSession):
...
class ParameterConfigurationSession(osid_sessions.OsidSession):
...
class ParameterConfigurationAssignmentSession(osid_sessions.OsidSession):
...
class ConfigurationLookupSession(osid_sessions.OsidSession):
...
class ConfigurationQuerySession(osid_sessions.OsidSession):
...
class ConfigurationSearchSession(ConfigurationQuerySession):
    """This session provides methods for searching among ``Configuration`` objects.
...
class ConfigurationAdminSession(osid_sessions.OsidSession):
...
class ConfigurationNotificationSession(osid_sessions.OsidSession):
...
class ConfigurationHierarchySession(osid_sessions.OsidSession):
    ...
    def use_comparative_configuration_view(self):
        """The returns from the configuration methods may omit or translate elements based on this session, such as authorization, and not result in an error.
...
class ConfigurationHierarchyDesignSession(osid_sessions.OsidSession):
