...
class LocationLookupSession(osid_sessions.OsidSession):
...
class LocationQuerySession(osid_sessions.OsidSession):
...
class LocationSearchSession(LocationQuerySession):
    """This session provides methods for searching among ``Location`` objects.
...
class LocationAdminSession(osid_sessions.OsidSession):
...
class LocationNotificationSession(osid_sessions.OsidSession):
...
class LocationHierarchySession(osid_sessions.OsidSession):
...
class LocationHierarchyDesignSession(osid_sessions.OsidSession):
...
class LocationMapSession(osid_sessions.OsidSession):
...
class LocationMapAssignmentSession(osid_sessions.OsidSession):
...
class LocationSmartMapSession(osid_sessions.OsidSession):
...
class LocationAdjacencySession(osid_sessions.OsidSession):
...
class LocationSpatialSession(osid_sessions.OsidSession):
...
class ResourceLocationSession(osid_sessions.OsidSession):
...
class ResourceLocationUpdateSession(osid_sessions.OsidSession):
...
class ResourceLocationNotificationSession(osid_sessions.OsidSession):
...
class ResourcePositionNotificationSession(osid_sessions.OsidSession):
...
class MyLocationSession(osid_sessions.OsidSession):
...
class MapLookupSession(osid_sessions.OsidSession):
...
class MapQuerySession(osid_sessions.OsidSession):
...
class MapSearchSession(MapQuerySession):
    """This session provides methods for searching among ``Map`` objects.
...
class MapAdminSession(osid_sessions.OsidSession):
...
class MapNotificationSession(osid_sessions.OsidSession):
...
class MapHierarchySession(osid_sessions.OsidSession):
...
class MapHierarchyDesignSession(osid_sessions.OsidSession):
