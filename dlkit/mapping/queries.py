...
class LocationQuery(osid_queries.OsidObjectQuery, osid_queries.OsidFederateableQuery):
    ...
    contained_spatial_unit_terms = property(fdel=clear_contained_spatial_unit_terms)
    ...
    overlapping_spatial_unit_terms = property(fdel=clear_overlapping_spatial_unit_terms)
    ...
    route_id_terms = property(fdel=clear_route_id_terms)
    ...
    route_query = property(fget=get_route_query)
    ...
    route_terms = property(fdel=clear_route_terms)
    ...
    path_id_terms = property(fdel=clear_path_id_terms)
    ...
    path_query = property(fget=get_path_query)
    ...
    containing_location_id_terms = property(fdel=clear_containing_location_id_terms)
    ...
    containing_location_query = property(fget=get_containing_location_query)
    ...
    containing_location_terms = property(fdel=clear_containing_location_terms)
    ...
    contained_location_id_terms = property(fdel=clear_contained_location_id_terms)
    ...
    contained_location_query = property(fget=get_contained_location_query)
    ...
    contained_location_terms = property(fdel=clear_contained_location_terms)
    ...
    map_id_terms = property(fdel=clear_map_id_terms)
    ...
    map_terms = property(fdel=clear_map_terms)
...
class MapQuery(osid_queries.OsidCatalogQuery):
    ...
    ancestor_map_id_terms = property(fdel=clear_ancestor_map_id_terms)
    ...
    ancestor_map_query = property(fget=get_ancestor_map_query)
    ...
    ancestor_map_terms = property(fdel=clear_ancestor_map_terms)
    ...
    descendant_map_id_terms = property(fdel=clear_descendant_map_id_terms)
    ...
    descendant_map_query = property(fget=get_descendant_map_query)
    ...
    descendant_map_terms = property(fdel=clear_descendant_map_terms)
