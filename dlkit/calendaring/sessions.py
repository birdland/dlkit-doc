...
class EventLookupSession(osid_sessions.OsidSession):
...
class EventQuerySession(osid_sessions.OsidSession):
...
class EventSearchSession(EventQuerySession):
    """This session provides methods for searching ``Event`` objects.
...
class EventAdminSession(osid_sessions.OsidSession):
...
class EventNotificationSession(osid_sessions.OsidSession):
...
class EventCalendarSession(osid_sessions.OsidSession):
...
class EventCalendarAssignmentSession(osid_sessions.OsidSession):
...
class EventSmartCalendarSession(osid_sessions.OsidSession):
...
class RecurringEventLookupSession(osid_sessions.OsidSession):
...
class RecurringEventUnravellingSession(osid_sessions.OsidSession):
...
class RecurringEventQuerySession(osid_sessions.OsidSession):
...
class RecurringEventSearchSession(RecurringEventQuerySession):
    """This session provides methods for searching ``RecurringEvent`` objects.
...
class RecurringEventAdminSession(osid_sessions.OsidSession):
...
class RecurringEventNotificationSession(osid_sessions.OsidSession):
...
class RecurringEventCalendarSession(osid_sessions.OsidSession):
...
class RecurringEventCalendarAssignmentSession(osid_sessions.OsidSession):
...
class RecurringEventSmartCalendarSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic catalogs.
...
class SupersedingEventLookupSession(osid_sessions.OsidSession):
...
class SupersedingEventQuerySession(osid_sessions.OsidSession):
...
class SupersedingEventSearchSession(SupersedingEventQuerySession):
    """This session provides methods for searching ``SupersedingEvent`` objects.
...
class SupersedingEventAdminSession(osid_sessions.OsidSession):
...
class SupersedingEventNotificationSession(osid_sessions.OsidSession):
...
class SupersedingEventCalendarSession(osid_sessions.OsidSession):
...
class SupersedingEventCalendarAssignmentSession(osid_sessions.OsidSession):
...
class SupersedingEventSmartCalendarSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic catalogs.
...
class OffsetEventLookupSession(osid_sessions.OsidSession):
...
class OffsetEventQuerySession(osid_sessions.OsidSession):
...
class OffsetEventSearchSession(OffsetEventQuerySession):
    """This session provides methods for searching ``OffsetEvent`` objects.
...
class OffsetEventAdminSession(osid_sessions.OsidSession):
...
class OffsetEventNotificationSession(osid_sessions.OsidSession):
...
class OffsetEventCalendarSession(osid_sessions.OsidSession):
...
class OffsetEventCalendarAssignmentSession(osid_sessions.OsidSession):
...
class OffsetEventSmartCalendarSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic catalogs.
...
class ScheduleLookupSession(osid_sessions.OsidSession):
...
class ScheduleQuerySession(osid_sessions.OsidSession):
...
class ScheduleSearchSession(ScheduleQuerySession):
    """This session provides methods for searching ``Schedule`` objects.
...
class ScheduleAdminSession(osid_sessions.OsidSession):
...
class ScheduleNotificationSession(osid_sessions.OsidSession):
...
class ScheduleCalendarSession(osid_sessions.OsidSession):
...
class ScheduleCalendarAssignmentSession(osid_sessions.OsidSession):
...
class ScheduleSmartCalendarSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic catalogs.
...
class ScheduleSlotLookupSession(osid_sessions.OsidSession):
...
class ScheduleSlotQuerySession(osid_sessions.OsidSession):
...
class ScheduleSlotSearchSession(ScheduleSlotQuerySession):
    """This session provides methods for searching ``ScheduleSlot`` objects.
...
class ScheduleSlotAdminSession(osid_sessions.OsidSession):
...
class ScheduleSlotNotificationSession(osid_sessions.OsidSession):
...
class ScheduleSlotCalendarSession(osid_sessions.OsidSession):
...
class ScheduleSlotCalendarAssignmentSession(osid_sessions.OsidSession):
...
class ScheduleSlotSmartCalendarSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic catalogs.
...
class CommitmentLookupSession(osid_sessions.OsidSession):
...
class CommitmentQuerySession(osid_sessions.OsidSession):
...
class CommitmentSearchSession(CommitmentQuerySession):
    """This session provides methods for searching ``Commitment`` objects.
...
class CommitmentAdminSession(osid_sessions.OsidSession):
...
class CommitmentNotificationSession(osid_sessions.OsidSession):
...
class CommitmentCalendarSession(osid_sessions.OsidSession):
...
class CommitmentCalendarAssignmentSession(osid_sessions.OsidSession):
...
class TimePeriodLookupSession(osid_sessions.OsidSession):
...
class TimePeriodQuerySession(osid_sessions.OsidSession):
...
class TimePeriodSearchSession(TimePeriodQuerySession):
    """This session provides methods for searching ``TimePeriod`` objects.
...
class TimePeriodAdminSession(osid_sessions.OsidSession):
...
class TimePeriodNotificationSession(osid_sessions.OsidSession):
...
class TimePeriodCalendarSession(osid_sessions.OsidSession):
...
class TimePeriodCalendarAssignmentSession(osid_sessions.OsidSession):
...
class CalendarLookupSession(osid_sessions.OsidSession):
...
class CalendarQuerySession(osid_sessions.OsidSession):
...
class CalendarSearchSession(CalendarQuerySession):
    """This session provides methods for searching among ``Calendar`` objects.
...
class CalendarAdminSession(osid_sessions.OsidSession):
...
class CalendarNotificationSession(osid_sessions.OsidSession):
...
class CalendarHierarchySession(osid_sessions.OsidSession):
    ...
    def use_comparative_calendar_view(self):
        """The returns from the calendar methods may omit or translate elements based on this session, such as authorization, and not result in an error.
...
class CalendarHierarchyDesignSession(osid_sessions.OsidSession):
