...
class EventSearch(osid_searches.OsidSearch):
...
class EventSearchResults(osid_searches.OsidSearchResults):
...
class RecurringEventSearch(osid_searches.OsidSearch):
...
class RecurringEventSearchResults(osid_searches.OsidSearchResults):
    """This interface provides a means to capture results of a search."""
    ...
    def get_recurring_event_search_results_record(self, recurring_event_search_record_type):
        """Gets the recurring event search results record corresponding to the given recurring event search record ``Type``.
...
class SupersedingEventSearch(osid_searches.OsidSearch):
...
class SupersedingEventSearchResults(osid_searches.OsidSearchResults):
    """This interface provides a means to capture results of a search."""
...
class OffsetEventSearch(osid_searches.OsidSearch):
...
class OffsetEventSearchResults(osid_searches.OsidSearchResults):
    """This interface provides a means to capture results of a search."""
...
class ScheduleSearch(osid_searches.OsidSearch):
...
class ScheduleSearchResults(osid_searches.OsidSearchResults):
    """This interface provides a means to capture results of a search."""
...
class ScheduleSlotSearch(osid_searches.OsidSearch):
...
class ScheduleSlotSearchResults(osid_searches.OsidSearchResults):
    """This interface provides a means to capture results of a search."""
...
class TimePeriodSearch(osid_searches.OsidSearch):
...
class TimePeriodSearchResults(osid_searches.OsidSearchResults):
    """This interface provides a means to capture results of a search."""
...
class CommitmentSearch(osid_searches.OsidSearch):
...
class CommitmentSearchResults(osid_searches.OsidSearchResults):
    """This interface provides a means to capture results of a search."""
...
class CalendarSearch(osid_searches.OsidSearch):
...
class CalendarSearchResults(osid_searches.OsidSearchResults):
    """This interface provides a means to capture results of a search."""
