...
class EventSearchOrder(osid_search_orders.OsidObjectSearchOrder, osid_search_orders.OsidTemporalSearchOrder, osid_search_orders.OsidContainableSearchOrder):
...
class SupersedingEventSearchOrder(osid_search_orders.OsidRuleSearchOrder):
    """An interface for specifying the ordering of search results."""
...
class OffsetEventSearchOrder(osid_search_orders.OsidRuleSearchOrder):
    """An interface for specifying the ordering of search results."""
...
class ScheduleSlotSearchOrder(osid_search_orders.OsidObjectSearchOrder, osid_search_orders.OsidContainableSearchOrder):
    """An interface for specifying the ordering of search results."""
...
class TimePeriodSearchOrder(osid_search_orders.OsidObjectSearchOrder):
    """An interface for specifying the ordering of search results."""
...
class CommitmentSearchOrder(osid_search_orders.OsidRelationshipSearchOrder):
    """An interface for specifying the ordering of search results."""
...
class CalendarSearchOrder(osid_search_orders.OsidCatalogSearchOrder):
    """An interface for specifying the ordering of search results."""
