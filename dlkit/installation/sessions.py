...
class InstallationLookupSession(osid_sessions.OsidSession):
...
class InstallationQuerySession(osid_sessions.OsidSession):
...
class InstallationSearchSession(InstallationQuerySession):
    """This session provides methods for searching ``Installations``.
...
class InstallationManagementSession(osid_sessions.OsidSession):
...
class InstallationUpdateSession(osid_sessions.OsidSession):
    """This session defines methods to manage installations."""
    def get_site_id(self):
        """Gets the ``Site``  ``Id`` associated with this session.
...
class InstallationNotificationSession(osid_sessions.OsidSession):
...
class SiteLookupSession(osid_sessions.OsidSession):
...
class PackageLookupSession(osid_sessions.OsidSession):
...
class PackageQuerySession(osid_sessions.OsidSession):
...
class PackageSearchSession(PackageQuerySession):
    """This session provides methods for searching ``Package`` objects.
...
class PackageAdminSession(osid_sessions.OsidSession):
...
class PackageNotificationSession(osid_sessions.OsidSession):
...
class PackageDepotSession(osid_sessions.OsidSession):
...
class PackageDepotAssignmentSession(osid_sessions.OsidSession):
...
class PackageSmartDepotSession(osid_sessions.OsidSession):
...
class DepotLookupSession(osid_sessions.OsidSession):
...
class DepotQuerySession(osid_sessions.OsidSession):
...
class DepotSearchSession(DepotQuerySession):
    """This session provides methods for searching among ``Depot`` objects.
...
class DepotAdminSession(osid_sessions.OsidSession):
...
class DepotNotificationSession(osid_sessions.OsidSession):
...
class DepotHierarchySession(osid_sessions.OsidSession):
    ...
    def use_comparative_depot_view(self):
        """The returns from the depot methods may omit or translate elements based on this session, such as authorization, and not result in an error.
...
class DepotHierarchyDesignSession(osid_sessions.OsidSession):
