...
class PackageSearchOrder(osid_search_orders.OsidObjectSearchOrder, osid_search_orders.OsidSourceableSearchOrder):
...
class DepotSearchOrder(osid_search_orders.OsidCatalogSearchOrder):
    """An interface for specifying the ordering of search results."""
...
class InstallationSearchOrder(osid_search_orders.OsidObjectSearchOrder):
    """An interface for specifying the ordering of search results."""
...
class SiteSearchOrder(osid_search_orders.OsidObjectSearchOrder):
    """An interface for specifying the ordering of search results."""
