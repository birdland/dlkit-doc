...
class LogEntrySearchSession(LogEntryQuerySession):
    """This session provides methods for searching among log entries.
...
class LogEntryNotificationSession(osid_sessions.OsidSession):
...
class LogEntryLogSession(osid_sessions.OsidSession):
...
class LogEntryLogAssignmentSession(osid_sessions.OsidSession):
...
class LogEntrySmartLogSession(osid_sessions.OsidSession):
...
class LogQuerySession(osid_sessions.OsidSession):
...
class LogSearchSession(LogQuerySession):
    """This session provides methods for searching ``Log`` objects.
...
class LogNotificationSession(osid_sessions.OsidSession):
...
class LogHierarchySession(osid_sessions.OsidSession):
...
class LogHierarchyDesignSession(osid_sessions.OsidSession):
