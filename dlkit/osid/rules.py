...
class OsidCondition(osid_markers.Extensible, osid_markers.Suppliable):
    """The ``OsidCondition`` is used to input conditions into a rule for evaluation."""



class OsidInput(osid_markers.Extensible, osid_markers.Suppliable):
    """The ``OsidInput`` is used to input conditions into a rule for processing."""



class OsidResult(osid_markers.Extensible, osid_markers.Browsable):
