"""Mongodb implementations of commenting sessions."""
...
from ...abstract_osid.commenting.objects import BookForm as ABCBookForm
from ...abstract_osid.commenting.objects import CommentForm as ABCCommentForm
...
class CommentLookupSession(abc_commenting_sessions.CommentLookupSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        ...
        self._session_name = 'CommentLookupSession'
    ...
    def get_comment(self, comment_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        collection = MongoClientValidated('commenting',
                                          collection='Comment',
                                          runtime=self._runtime)
        result = collection.find_one(
            dict({'_id': ObjectId(self._get_id(comment_id, 'commenting').get_identifier())},
                 **self._view_filter()))
        return objects.Comment(result, runtime=self._runtime)
        ...
        for object_id in object_id_list:
            for object_map in result:
                if object_map['_id'] == object_id:
                    ...
                    break
        return objects.CommentList(sorted_result, runtime=self._runtime)
...
class CommentQuerySession(abc_commenting_sessions.CommentQuerySession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.Book
        self._session_name = 'CommentQuerySession'
        self._catalog_name = 'Book'
        OsidSession._init_object(
            self,
            catalog_id,
...
class CommentAdminSession(abc_commenting_sessions.CommentAdminSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.Book
        self._session_name = 'CommentAdminSession'
        self._catalog_name = 'Book'
        OsidSession._init_object(
            self,
            catalog_id,
    ...
    def get_comment_form_for_update(self, comment_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        obj_form = objects.CommentForm(result, runtime=self._runtime)
    ...
    def _get_comment_id_with_enclosure(self, enclosure_id):
        ...
        query_session = mgr.get_comment_query_session_for_book(self._catalog_id)
    ...
    def duplicate_comment(self, comment_id):
        ...
        lookup_session = mgr.get_comment_lookup_session()
    ...
    def delete_comment(self, comment_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        objects.Comment(comment_map, runtime=self._runtime)._delete()
...
class BookLookupSession(abc_commenting_sessions.BookLookupSession, osid_sessions.OsidSession):
    ...
    _session_name = 'BookLookupSession'
    ...
    def get_book(self, book_id):
        ...
        *compliance: mandatory -- This method is must be implemented.*
        ...
        return objects.Book(result, runtime=self._runtime)
    ...
    def get_books_by_ids(self, book_ids):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        return objects.BookList(result, runtime=self._runtime)
...
class BookAdminSession(abc_commenting_sessions.BookAdminSession, osid_sessions.OsidSession):
    ...
    _session_name = 'BookAdminSession'
    ...
    def get_book_form_for_update(self, book_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        cat_form = objects.BookForm(result, runtime=self._runtime)
    ...
    def update_book(self, book_form):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Note: this is out of spec. The OSIDs don't require an object to be returned
        return objects.Book(book_form._my_map, runtime=self._runtime)
    ...
    def delete_book(self, book_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        for object_catalog in ['Comment', 'Rating', 'Book']:
            obj_collection = MongoClientValidated('commenting',
...
class BookHierarchySession(abc_commenting_sessions.BookHierarchySession, osid_sessions.OsidSession):
    ...
    _session_name = 'BookHierarchySession'
...
class BookHierarchyDesignSession(abc_commenting_sessions.BookHierarchyDesignSession, osid_sessions.OsidSession):
    ...
    _session_name = 'BookHierarchyDesignSession'
