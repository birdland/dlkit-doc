"""Mongodb implementations of authorization managers."""
...
class AuthorizationProfile(osid_managers.OsidProfile, authorization_managers.AuthorizationProfile):
    ...
    def supports_authorization(self):
        """Tests for the availability of an authorization service which is the basic service for checking
            authorizations.
    ...
    def get_authorization_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        record_type_maps = self._get_registry('AUTHORIZATION_RECORD_TYPES')
        record_types = []
    ...
    def get_authorization_search_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('AUTHORIZATION_SEARCH_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
    ...
    def get_function_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('FUNCTION_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
    ...
    def get_function_search_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('FUNCTION_SEARCH_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
    ...
    def get_qualifier_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('QUALIFIER_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
    ...
    def get_qualifier_search_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('QUALIFIER_SEARCH_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
    ...
    def get_vault_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('VAULT_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
    ...
    def get_vault_search_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('VAULT_SEARCH_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
    ...
    def get_authorization_condition_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('AUTHORIZATION_CONDITION_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
...
class AuthorizationManager(osid_managers.OsidManager, AuthorizationProfile, authorization_managers.AuthorizationManager):
    """The authorization manager provides access to authorization sessions and provides interoperability tests for
        various
    ...
    def get_authorization_session_for_vault(self, vault_id):
        """Gets an ``AuthorizationSession`` which is responsible for performing authorization checks for the given
            vault.
