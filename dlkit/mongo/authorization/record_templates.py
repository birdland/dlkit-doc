"""Mongodb implementations of authorization records."""
...
from dlkit.mongo.osid import records as osid_records




class AuthorizationRecord(abc_authorization_records.AuthorizationRecord, osid_records.OsidRecord):
    """A record for an ``Authorization`` The methods specified by the record type are available through the underlying
        object."""
