"""Mongodb implementations of grading objects."""
...
class Grade(abc_grading_objects.Grade, osid_objects.OsidObject, osid_markers.Subjugateable):
    ...
    def __init__(self, osid_object_map, runtime=None):
        ...
        self._record_type_data_sets = self._get_registry('GRADE_RECORD_TYPES')
        self._records = dict()
...
class GradeForm(abc_grading_objects.GradeForm, osid_objects.OsidObjectForm, osid_objects.OsidSubjugateableForm):
    ...
    def _init_metadata(self, **kwargs):
        ...
        self._output_score_metadata = {
            'element_id': Id(
                self._authority,
                self._namespace,
                'output_score')}
        self._output_score_metadata.update(mdata_conf.GRADE_OUTPUT_SCORE)
        self._input_score_end_range_metadata = {
            'element_id': Id(
                self._authority,
                self._namespace,
                'input_score_end_range')}
        self._input_score_end_range_metadata.update(mdata_conf.GRADE_INPUT_SCORE_END_RANGE)
        self._input_score_start_range_metadata = {
            'element_id': Id(
                self._authority,
                self._namespace,
                'input_score_start_range')}
        self._input_score_start_range_metadata.update(mdata_conf.GRADE_INPUT_SCORE_START_RANGE)
        self._output_score_default = self._output_score_metadata['default_decimal_values'][0]
        self._input_score_end_range_default = self._input_score_end_range_metadata['default_decimal_values'][0]
        self._input_score_start_range_default = self._input_score_start_range_metadata['default_decimal_values'][0]
    ...
    def get_input_score_start_range_metadata(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        metadata = dict(self._input_score_start_range_metadata)
        metadata.update({'existing_input_score_start_range_values': self._my_map['inputScoreStartRange']})
    ...
    def get_input_score_end_range_metadata(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        """
        # Implemented from template for osid.resource.ResourceForm.get_group_metadata_template
        metadata = dict(self._input_score_end_range_metadata)
        metadata.update({'existing_input_score_end_range_values': self._my_map['inputScoreEndRange']})
        return Metadata(**metadata)
    ...
    def get_output_score_metadata(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        """
        # Implemented from template for osid.resource.ResourceForm.get_group_metadata_template
        metadata = dict(self._output_score_metadata)
        metadata.update({'existing_output_score_values': self._my_map['outputScore']})
        return Metadata(**metadata)
...
class GradeSystem(abc_grading_objects.GradeSystem, osid_objects.OsidObject, osid_markers.Aggregateable):
    ...
    def __init__(self, osid_object_map, runtime=None):
        osid_objects.OsidObject.__init__(self, osid_object_map, runtime)
        self._record_type_data_sets = self._get_registry('GRADE_SYSTEM_RECORD_TYPES')
        self._records = dict()
        self._load_records(osid_object_map['recordTypeIds'])
        self._catalog_name = 'gradebook'
    ...
    def get_grades(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        return GradeList(self._my_map['grades'], runtime=self._runtime)
...
class GradeSystemForm(abc_grading_objects.GradeSystemForm, osid_objects.OsidObjectForm, osid_objects.OsidAggregateableForm):
    ...
    def _init_metadata(self, **kwargs):
        osid_objects.OsidObjectForm._init_metadata(self, **kwargs)
        self._numeric_score_increment_metadata = {
            'element_id': Id(
                self._authority,
                self._namespace,
                'numeric_score_increment')}
        self._numeric_score_increment_metadata.update(mdata_conf.GRADE_SYSTEM_NUMERIC_SCORE_INCREMENT)
        self._lowest_numeric_score_metadata = {
            'element_id': Id(
                self._authority,
                self._namespace,
                'lowest_numeric_score')}
        self._lowest_numeric_score_metadata.update(mdata_conf.GRADE_SYSTEM_LOWEST_NUMERIC_SCORE)
        self._based_on_grades_metadata = {
            'element_id': Id(
                self._authority,
                self._namespace,
                'based_on_grades')}
        self._based_on_grades_metadata.update(mdata_conf.GRADE_SYSTEM_BASED_ON_GRADES)
        self._highest_numeric_score_metadata = {
            'element_id': Id(
                self._authority,
                self._namespace,
                'highest_numeric_score')}
        self._highest_numeric_score_metadata.update(mdata_conf.GRADE_SYSTEM_HIGHEST_NUMERIC_SCORE)
        self._numeric_score_increment_default = self._numeric_score_increment_metadata['default_decimal_values'][0]
        self._lowest_numeric_score_default = self._lowest_numeric_score_metadata['default_decimal_values'][0]
        self._based_on_grades_default = None
        self._highest_numeric_score_default = self._highest_numeric_score_metadata['default_decimal_values'][0]
    ...
    def get_based_on_grades_metadata(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        """
        # Implemented from template for osid.resource.ResourceForm.get_group_metadata_template
        metadata = dict(self._based_on_grades_metadata)
        metadata.update({'existing_based_on_grades_values': self._my_map['basedOnGrades']})
        return Metadata(**metadata)
    ...
    def get_lowest_numeric_score_metadata(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        """
        # Implemented from template for osid.resource.ResourceForm.get_group_metadata_template
        metadata = dict(self._lowest_numeric_score_metadata)
        metadata.update({'existing_lowest_numeric_score_values': self._my_map['lowestNumericScore']})
        return Metadata(**metadata)
    ...
    def get_numeric_score_increment_metadata(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        """
        # Implemented from template for osid.resource.ResourceForm.get_group_metadata_template
        metadata = dict(self._numeric_score_increment_metadata)
        metadata.update({'existing_numeric_score_increment_values': self._my_map['numericScoreIncrement']})
        return Metadata(**metadata)
    ...
    def get_highest_numeric_score_metadata(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        """
        # Implemented from template for osid.resource.ResourceForm.get_group_metadata_template
        metadata = dict(self._highest_numeric_score_metadata)
        metadata.update({'existing_highest_numeric_score_values': self._my_map['highestNumericScore']})
        return Metadata(**metadata)
...
class GradeEntry(abc_grading_objects.GradeEntry, osid_objects.OsidRelationship):
    ...
    def get_overridden_calculated_entry(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        """
        # Implemented from template for osid.resource.Resource.get_avatar_template
        if not self._my_map['overriddenCalculatedEntryId']:
        ...
        lookup_session = mgr.get_grade_entry_lookup_session()
        lookup_session.use_federated_gradebook_view()
...
class GradeEntryForm(abc_grading_objects.GradeEntryForm, osid_objects.OsidRelationshipForm):
    ...
    def get_ignored_for_calculations_metadata(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        """
        # Implemented from template for osid.resource.ResourceForm.get_group_metadata_template
        metadata = dict(self._ignored_for_calculations_metadata)
        metadata.update({'existing_ignored_for_calculations_values': self._my_map['ignoredForCalculations']})
        return Metadata(**metadata)
    ...
    def get_grade_metadata(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        """
        # Implemented from template for osid.resource.ResourceForm.get_group_metadata_template
        metadata = dict(self._grade_metadata)
        metadata.update({'existing_grade_values': self._my_map['gradeId']})
        return Metadata(**metadata)
    ...
    def get_score_metadata(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        """
        # Implemented from template for osid.resource.ResourceForm.get_group_metadata_template
        metadata = dict(self._score_metadata)
        metadata.update({'existing_score_values': self._my_map['score']})
        return Metadata(**metadata)
...
class GradebookColumn(abc_grading_objects.GradebookColumn, osid_objects.OsidObject):
    ...
    def __init__(self, osid_object_map, runtime=None):
        osid_objects.OsidObject.__init__(self, osid_object_map, runtime)
        self._record_type_data_sets = self._get_registry('GRADEBOOK_COLUMN_RECORD_TYPES')
        self._records = dict()
        self._load_records(osid_object_map['recordTypeIds'])
        self._catalog_name = 'gradebook'
    ...
    def _init_metadata(self, **kwargs):
        ...
        self._grade_system_metadata = {
            'element_id': Id(
                ...
                self._namespace,
                'grade_system')}
        self._grade_system_metadata.update(mdata_conf.GRADEBOOK_COLUMN_GRADE_SYSTEM)
...
class Gradebook(abc_grading_objects.Gradebook, osid_objects.OsidCatalog):
    ...
    def __init__(self, osid_catalog_map, runtime=None):
        ...
        self._record_type_data_sets = self._get_registry('GRADEBOOK_RECORD_TYPES')
        self._records = dict()
...
class GradebookNode(abc_grading_objects.GradebookNode, osid_objects.OsidNode):
    ...
    def get_object_node_map(self):
        node_map = dict(self.get_gradebook().get_object_map())
        node_map['type'] = 'GradebookNode'
        node_map['parentNodes'] = []
        node_map['childNodes'] = []
        for gradebook_node in self.get_parent_gradebook_nodes():
            node_map['parentNodes'].append(gradebook_node.get_object_node_map())
    ...
    def get_gradebook(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        if self._lookup_session is None:
            ...
            self._lookup_session = mgr.get_gradebook_lookup_session()
