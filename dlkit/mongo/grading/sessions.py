"""Mongodb implementations of grading sessions."""
...
from ...abstract_osid.grading.objects import GradeEntryForm as ABCGradeEntryForm
from ...abstract_osid.grading.objects import GradeSystemForm as ABCGradeSystemForm
from ...abstract_osid.grading.objects import GradebookColumnForm as ABCGradebookColumnForm
from ...abstract_osid.grading.objects import GradebookForm as ABCGradebookForm
...
class GradeSystemLookupSession(abc_grading_sessions.GradeSystemLookupSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        ...
        self._session_name = 'GradeSystemLookupSession'
        ...
        *compliance: mandatory -- This method is must be implemented.*
        ...
        result = collection.find_one(
            dict({'_id': ObjectId(self._get_id(grade_system_id, 'grading').get_identifier())},
                 **self._view_filter()))
        return objects.GradeSystem(result, runtime=self._runtime)
        ...
        for object_id in object_id_list:
            for object_map in result:
                if object_map['_id'] == object_id:
                    ...
                    break
        return objects.GradeSystemList(sorted_result, runtime=self._runtime)
    ...
    def get_grade_systems_by_genus_type(self, grade_system_genus_type):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        return objects.GradeSystemList(result, runtime=self._runtime)
...
class GradeSystemQuerySession(abc_grading_sessions.GradeSystemQuerySession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.Gradebook
        self._session_name = 'GradeSystemQuerySession'
        self._catalog_name = 'Gradebook'
        OsidSession._init_object(
            self,
            catalog_id,
...
class GradeSystemAdminSession(abc_grading_sessions.GradeSystemAdminSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.Gradebook
        self._session_name = 'GradeSystemAdminSession'
        self._catalog_name = 'Gradebook'
        OsidSession._init_object(
            self,
            catalog_id,
    ...
    def get_grade_system_form_for_update(self, grade_system_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        obj_form = objects.GradeSystemForm(result, runtime=self._runtime)
    ...
    def _get_grade_system_id_with_enclosure(self, enclosure_id):
        ...
        query_session = mgr.get_grade_system_query_session_for_gradebook(self._catalog_id)
    ...
    def create_grade(self, grade_form):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        from ...abstract_osid.grading.objects import GradeForm as ABCGradeForm
        collection = MongoClientValidated('grading',
                                          collection='GradeSystem',
                                          runtime=self._runtime)
        ...
        return Grade(grade_form._my_map, runtime=self._runtime)
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        for sub_doc in document['grades']: # There may be a MongoDB shortcut for this
            if sub_doc['_id'] == ObjectId(grade_id.get_identifier()):
                result = sub_doc
        obj_form = GradeForm(result, runtime=self._runtime)
    ...
    def delete_grade(self, grade_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        if not found:
            raise errors.OperationFailed()
        Grade(grade_map, runtime=self._runtime)._delete()
        collection.save(grade_system)
...
class GradeEntryLookupSession(abc_grading_sessions.GradeEntryLookupSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.Gradebook
        self._session_name = 'GradeEntryLookupSession'
        self._catalog_name = 'Gradebook'
        OsidSession._init_object(
            self,
            catalog_id,
        ...
        *compliance: mandatory -- This method is must be implemented.*
        ...
        result = collection.find_one(
            dict({'_id': ObjectId(self._get_id(grade_entry_id, 'grading').get_identifier())},
                 **self._view_filter()))
        return objects.GradeEntry(result, runtime=self._runtime)
        ...
        for object_id in object_id_list:
            for object_map in result:
                if object_map['_id'] == object_id:
                    sorted_result.append(object_map)
                    break
        return objects.GradeEntryList(sorted_result, runtime=self._runtime)
...
class GradeEntryQuerySession(abc_grading_sessions.GradeEntryQuerySession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.Gradebook
        self._session_name = 'GradeEntryQuerySession'
        self._catalog_name = 'Gradebook'
        OsidSession._init_object(
            self,
            catalog_id,
...
class GradeEntryAdminSession(abc_grading_sessions.GradeEntryAdminSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.Gradebook
        self._session_name = 'GradeEntryAdminSession'
        self._catalog_name = 'Gradebook'
        OsidSession._init_object(
            self,
            catalog_id,
    ...
    def delete_grade_entry(self, grade_entry_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        objects.GradeEntry(grade_entry_map, runtime=self._runtime)._delete()
...
class GradebookColumnLookupSession(abc_grading_sessions.GradebookColumnLookupSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.Gradebook
        self._session_name = 'GradebookColumnLookupSession'
        self._catalog_name = 'Gradebook'
        OsidSession._init_object(
            self,
            catalog_id,
        ...
        *compliance: mandatory -- This method is must be implemented.*
        ...
        result = collection.find_one(
            dict({'_id': ObjectId(self._get_id(gradebook_column_id, 'grading').get_identifier())},
                 **self._view_filter()))
        return objects.GradebookColumn(result, runtime=self._runtime)
        ...
        for object_id in object_id_list:
            for object_map in result:
                if object_map['_id'] == object_id:
                    sorted_result.append(object_map)
                    break
        return objects.GradebookColumnList(sorted_result, runtime=self._runtime)
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        result = collection.find(
            dict({'genusTypeId': str(gradebook_column_genus_type)},
                 **self._view_filter())).sort('_id', DESCENDING)
        return objects.GradebookColumnList(result, runtime=self._runtime)
...
class GradebookColumnQuerySession(abc_grading_sessions.GradebookColumnQuerySession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.Gradebook
        self._session_name = 'GradebookColumnQuerySession'
        self._catalog_name = 'Gradebook'
        OsidSession._init_object(
            self,
            catalog_id,
...
class GradebookColumnAdminSession(abc_grading_sessions.GradebookColumnAdminSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.Gradebook
        self._session_name = 'GradebookColumnAdminSession'
        self._catalog_name = 'Gradebook'
        OsidSession._init_object(
            self,
            catalog_id,
    ...
    def get_gradebook_column_form_for_update(self, gradebook_column_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        obj_form = objects.GradebookColumnForm(result, runtime=self._runtime)
        self._forms[obj_form.get_id().get_identifier()] = not UPDATED
    ...
    def _get_gradebook_column_id_with_enclosure(self, enclosure_id):
        ...
        """
        mgr = self._get_provider_manager('REPOSITORY')
        query_session = mgr.get_gradebook_column_query_session_for_gradebook(self._catalog_id)
...
class GradebookLookupSession(abc_grading_sessions.GradebookLookupSession, osid_sessions.OsidSession):
    ...
    _session_name = 'GradebookLookupSession'
    ...
    def get_gradebook(self, gradebook_id):
        ...
        *compliance: mandatory -- This method is must be implemented.*
        ...
        return objects.Gradebook(result, runtime=self._runtime)
    ...
    def get_gradebooks_by_ids(self, gradebook_ids):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        return objects.GradebookList(result, runtime=self._runtime)
...
class GradebookAdminSession(abc_grading_sessions.GradebookAdminSession, osid_sessions.OsidSession):
    ...
    _session_name = 'GradebookAdminSession'
    ...
    def get_gradebook_form_for_update(self, gradebook_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        cat_form = objects.GradebookForm(result, runtime=self._runtime)
    ...
    def update_gradebook(self, gradebook_form):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Note: this is out of spec. The OSIDs don't require an object to be returned
        return objects.Gradebook(gradebook_form._my_map, runtime=self._runtime)
    ...
    def delete_gradebook(self, gradebook_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        for object_catalog in ['GradeSystem', 'GradeEntry', 'GradebookColumn', 'Gradebook']:
            obj_collection = MongoClientValidated('grading',
