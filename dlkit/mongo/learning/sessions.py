"""Mongodb implementations of learning sessions."""
...
from ...abstract_osid.learning.objects import ActivityForm as ABCActivityForm
from ...abstract_osid.learning.objects import ObjectiveBankForm as ABCObjectiveBankForm
from ...abstract_osid.learning.objects import ObjectiveForm as ABCObjectiveForm
from ...abstract_osid.learning.objects import ProficiencyForm as ABCProficiencyForm
...
class ObjectiveLookupSession(abc_learning_sessions.ObjectiveLookupSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        ...
        self._session_name = 'ObjectiveLookupSession'
        ...
        *compliance: mandatory -- This method is must be implemented.*
        ...
        result = collection.find_one(
            dict({'_id': ObjectId(self._get_id(objective_id, 'learning').get_identifier())},
                 **self._view_filter()))
        return objects.Objective(result, runtime=self._runtime)
        ...
        for object_id in object_id_list:
            for object_map in result:
                if object_map['_id'] == object_id:
                    ...
                    break
        return objects.ObjectiveList(sorted_result, runtime=self._runtime)
...
class ObjectiveQuerySession(abc_learning_sessions.ObjectiveQuerySession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.ObjectiveBank
        self._session_name = 'ObjectiveQuerySession'
        self._catalog_name = 'ObjectiveBank'
        OsidSession._init_object(
            self,
            catalog_id,
...
class ObjectiveAdminSession(abc_learning_sessions.ObjectiveAdminSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.ObjectiveBank
        self._session_name = 'ObjectiveAdminSession'
        self._catalog_name = 'ObjectiveBank'
        OsidSession._init_object(
            self,
            catalog_id,
    ...
    def get_objective_form_for_update(self, objective_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        obj_form = objects.ObjectiveForm(result, runtime=self._runtime)
    ...
    def _get_objective_id_with_enclosure(self, enclosure_id):
        ...
        query_session = mgr.get_objective_query_session_for_objective_bank(self._catalog_id)
...
class ObjectiveObjectiveBankSession(abc_learning_sessions.ObjectiveObjectiveBankSession, osid_sessions.OsidSession):
    ...
    _session_name = 'ObjectiveObjectiveBankSession'
    ...
    def get_objectives_by_objective_bank(self, objective_bank_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        mgr = self._get_provider_manager('LEARNING')
        lookup_session = mgr.get_objective_lookup_session_for_objective_bank(objective_bank_id)
    ...
    def get_objective_banks_by_objective(self, objective_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        mgr = self._get_provider_manager('LEARNING')
        lookup_session = mgr.get_objective_bank_lookup_session()
...
class ObjectiveObjectiveBankAssignmentSession(abc_learning_sessions.ObjectiveObjectiveBankAssignmentSession, osid_sessions.OsidSession):
    ...
    def __init__(self, proxy=None, runtime=None, **kwargs):
        OsidSession._init_catalog(self, proxy, runtime)
        self._session_name = 'ObjectiveObjectiveBankAssignmentSession'
        self._catalog_name = 'ObjectiveBank'
        self._forms = dict()
        self._kwargs = kwargs
...
class ActivityLookupSession(abc_learning_sessions.ActivityLookupSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.ObjectiveBank
        self._session_name = 'ActivityLookupSession'
        self._catalog_name = 'ObjectiveBank'
        OsidSession._init_object(
            self,
            catalog_id,
        ...
        *compliance: mandatory -- This method is must be implemented.*
        ...
        result = collection.find_one(
            dict({'_id': ObjectId(self._get_id(activity_id, 'learning').get_identifier())},
                 **self._view_filter()))
        return objects.Activity(result, runtime=self._runtime)
        ...
        for object_id in object_id_list:
            for object_map in result:
                if object_map['_id'] == object_id:
                    sorted_result.append(object_map)
                    break
        return objects.ActivityList(sorted_result, runtime=self._runtime)
...
class ActivityAdminSession(abc_learning_sessions.ActivityAdminSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.ObjectiveBank
        self._session_name = 'ActivityAdminSession'
        self._catalog_name = 'ObjectiveBank'
        OsidSession._init_object(
            self,
            catalog_id,
    ...
    def get_activity_form_for_update(self, activity_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        obj_form = objects.ActivityForm(result, runtime=self._runtime)
        self._forms[obj_form.get_id().get_identifier()] = not UPDATED
    ...
    def _get_activity_id_with_enclosure(self, enclosure_id):
        ...
        """
        mgr = self._get_provider_manager('REPOSITORY')
        query_session = mgr.get_activity_query_session_for_objective_bank(self._catalog_id)
    ...
    def duplicate_activity(self, activity_id):
        collection = MongoClientValidated('learning',
                                          ...
                                          runtime=self._runtime)
        mgr = self._get_provider_manager('LEARNING')
        lookup_session = mgr.get_activity_lookup_session()
        lookup_session.use_federated_objective_bank_view()
        try:
    ...
    def delete_activity(self, activity_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        objects.Activity(activity_map, runtime=self._runtime)._delete()
...
class ActivityObjectiveBankSession(abc_learning_sessions.ActivityObjectiveBankSession, osid_sessions.OsidSession):
    ...
    _session_name = 'ActivityObjectiveBankSession'
    ...
    def get_activities_by_objective_bank(self, objective_bank_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # osid.resource.ResourceBinSession.get_resources_by_bin
        mgr = self._get_provider_manager('LEARNING')
        lookup_session = mgr.get_activity_lookup_session_for_objective_bank(objective_bank_id)
        lookup_session.use_isolated_objective_bank_view()
...
class ActivityObjectiveBankAssignmentSession(abc_learning_sessions.ActivityObjectiveBankAssignmentSession, osid_sessions.OsidSession):
    ...
    def __init__(self, proxy=None, runtime=None, **kwargs):
        OsidSession._init_catalog(self, proxy, runtime)
        self._session_name = 'ActivityObjectiveBankAssignmentSession'
        self._catalog_name = 'ObjectiveBank'
        self._forms = dict()
        self._kwargs = kwargs
...
class ProficiencyLookupSession(abc_learning_sessions.ProficiencyLookupSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.ObjectiveBank
        self._session_name = 'ProficiencyLookupSession'
        self._catalog_name = 'ObjectiveBank'
        OsidSession._init_object(
            self,
            catalog_id,
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        result = collection.find_one(
            dict({'_id': ObjectId(self._get_id(proficiency_id, 'learning').get_identifier())},
                 **self._view_filter()))
        return objects.Proficiency(result, runtime=self._runtime)
        ...
        for object_id in object_id_list:
            for object_map in result:
                if object_map['_id'] == object_id:
                    sorted_result.append(object_map)
                    break
        return objects.ProficiencyList(sorted_result, runtime=self._runtime)
...
class ProficiencyQuerySession(abc_learning_sessions.ProficiencyQuerySession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.ObjectiveBank
        self._session_name = 'ProficiencyQuerySession'
        self._catalog_name = 'ObjectiveBank'
        OsidSession._init_object(
            self,
            catalog_id,
...
class ProficiencyAdminSession(abc_learning_sessions.ProficiencyAdminSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.ObjectiveBank
        self._session_name = 'ProficiencyAdminSession'
        self._catalog_name = 'ObjectiveBank'
        OsidSession._init_object(
            self,
            catalog_id,
    ...
    def get_proficiency_form_for_update(self, proficiency_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        obj_form = objects.ProficiencyForm(result, runtime=self._runtime)
        self._forms[obj_form.get_id().get_identifier()] = not UPDATED
    ...
    def _get_proficiency_id_with_enclosure(self, enclosure_id):
        ...
        """
        mgr = self._get_provider_manager('REPOSITORY')
        query_session = mgr.get_proficiency_query_session_for_objective_bank(self._catalog_id)
    ...
    def duplicate_proficiency(self, proficiency_id):
        collection = MongoClientValidated('learning',
                                          ...
                                          runtime=self._runtime)
        mgr = self._get_provider_manager('LEARNING')
        lookup_session = mgr.get_proficiency_lookup_session()
        lookup_session.use_federated_objective_bank_view()
        try:
    ...
    def delete_proficiency(self, proficiency_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        objects.Proficiency(proficiency_map, runtime=self._runtime)._delete()
...
class ObjectiveBankLookupSession(abc_learning_sessions.ObjectiveBankLookupSession, osid_sessions.OsidSession):
    ...
    _session_name = 'ObjectiveBankLookupSession'
    ...
    def get_objective_bank(self, objective_bank_id):
        ...
        *compliance: mandatory -- This method is must be implemented.*
        ...
        return objects.ObjectiveBank(result, runtime=self._runtime)
    ...
    def get_objective_banks_by_ids(self, objective_bank_ids):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        return objects.ObjectiveBankList(result, runtime=self._runtime)
...
class ObjectiveBankAdminSession(abc_learning_sessions.ObjectiveBankAdminSession, osid_sessions.OsidSession):
    ...
    _session_name = 'ObjectiveBankAdminSession'
    ...
    def get_objective_bank_form_for_update(self, objective_bank_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        cat_form = objects.ObjectiveBankForm(result, runtime=self._runtime)
    ...
    def update_objective_bank(self, objective_bank_form):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Note: this is out of spec. The OSIDs don't require an object to be returned
        return objects.ObjectiveBank(objective_bank_form._my_map, runtime=self._runtime)
    ...
    def delete_objective_bank(self, objective_bank_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        for object_catalog in ['Objective', 'Activity', 'Proficiency', 'ObjectiveBank']:
            obj_collection = MongoClientValidated('learning',
...
class ObjectiveBankHierarchySession(abc_learning_sessions.ObjectiveBankHierarchySession, osid_sessions.OsidSession):
    ...
    _session_name = 'ObjectiveBankHierarchySession'
...
class ObjectiveBankHierarchyDesignSession(abc_learning_sessions.ObjectiveBankHierarchyDesignSession, osid_sessions.OsidSession):
    ...
    _session_name = 'ObjectiveBankHierarchyDesignSession'
