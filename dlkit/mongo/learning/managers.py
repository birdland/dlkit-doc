"""Mongodb implementations of learning managers."""
...
class LearningProfile(osid_managers.OsidProfile, learning_managers.LearningProfile):
    ...
    def get_objective_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        record_type_maps = self._get_registry('OBJECTIVE_RECORD_TYPES')
        record_types = []
    ...
    def get_objective_search_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('OBJECTIVE_SEARCH_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
    ...
    def get_activity_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('ACTIVITY_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
    ...
    def get_activity_search_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('ACTIVITY_SEARCH_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
    ...
    def get_proficiency_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('PROFICIENCY_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
    ...
    def get_proficiency_search_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('PROFICIENCY_SEARCH_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
    ...
    def get_objective_bank_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('OBJECTIVE_BANK_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
    ...
    def get_objective_bank_search_record_types(self):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Implemented from template for
        # osid.resource.ResourceProfile.get_resource_record_types_template
        record_type_maps = self._get_registry('OBJECTIVE_BANK_SEARCH_RECORD_TYPES')
        record_types = []
        for record_type_map in record_type_maps:
            record_types.append(Type(**record_type_maps[record_type_map]))
        return TypeList(record_types)
