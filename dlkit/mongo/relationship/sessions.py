"""Mongodb implementations of relationship sessions."""
...
from ...abstract_osid.relationship.objects import FamilyForm as ABCFamilyForm
from ...abstract_osid.relationship.objects import RelationshipForm as ABCRelationshipForm
...
class RelationshipLookupSession(abc_relationship_sessions.RelationshipLookupSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        ...
        self._session_name = 'RelationshipLookupSession'
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        result = collection.find_one(
            dict({'_id': ObjectId(self._get_id(relationship_id, 'relationship').get_identifier())},
                 **self._view_filter()))
        return objects.Relationship(result, runtime=self._runtime)
        ...
        for object_id in object_id_list:
            for object_map in result:
                if object_map['_id'] == object_id:
                    ...
                    break
        return objects.RelationshipList(sorted_result, runtime=self._runtime)
...
class RelationshipQuerySession(abc_relationship_sessions.RelationshipQuerySession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.Family
        self._session_name = 'RelationshipQuerySession'
        self._catalog_name = 'Family'
        OsidSession._init_object(
            self,
            catalog_id,
...
class RelationshipAdminSession(abc_relationship_sessions.RelationshipAdminSession, osid_sessions.OsidSession):
    ...
    def __init__(self, catalog_id=None, proxy=None, runtime=None, **kwargs):
        OsidSession.__init__(self)
        self._catalog_class = objects.Family
        self._session_name = 'RelationshipAdminSession'
        self._catalog_name = 'Family'
        OsidSession._init_object(
            self,
            catalog_id,
    ...
    def get_relationship_form_for_update(self, relationship_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        obj_form = objects.RelationshipForm(result, runtime=self._runtime)
    ...
    def _get_relationship_id_with_enclosure(self, enclosure_id):
        ...
        query_session = mgr.get_relationship_query_session_for_family(self._catalog_id)
    ...
    def duplicate_relationship(self, relationship_id):
        ...
        lookup_session = mgr.get_relationship_lookup_session()
    ...
    def delete_relationship(self, relationship_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        objects.Relationship(relationship_map, runtime=self._runtime)._delete()
...
class FamilyLookupSession(abc_relationship_sessions.FamilyLookupSession, osid_sessions.OsidSession):
    ...
    _session_name = 'FamilyLookupSession'
    ...
    def get_family(self, family_id):
        ...
        *compliance: mandatory -- This method is must be implemented.*
        ...
        if family_id.get_identifier() == '000000000000000000000000':
        ...
        return objects.Family(result, runtime=self._runtime)
    ...
    def get_families_by_ids(self, family_ids):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        return objects.FamilyList(result, runtime=self._runtime)
...
class FamilyAdminSession(abc_relationship_sessions.FamilyAdminSession, osid_sessions.OsidSession):
    ...
    _session_name = 'FamilyAdminSession'
    ...
    def get_family_form_for_update(self, family_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        cat_form = objects.FamilyForm(result, runtime=self._runtime)
    ...
    def update_family(self, family_form):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        # Note: this is out of spec. The OSIDs don't require an object to be returned
        return objects.Family(family_form._my_map, runtime=self._runtime)
    ...
    def delete_family(self, family_id):
        ...
        *compliance: mandatory -- This method must be implemented.*
        ...
        for object_catalog in ['Relationship', 'Family']:
            obj_collection = MongoClientValidated('relationship',
...
class FamilyHierarchySession(abc_relationship_sessions.FamilyHierarchySession, osid_sessions.OsidSession):
    ...
    _session_name = 'FamilyHierarchySession'
...
class FamilyHierarchyDesignSession(abc_relationship_sessions.FamilyHierarchyDesignSession, osid_sessions.OsidSession):
    ...
    _session_name = 'FamilyHierarchyDesignSession'
