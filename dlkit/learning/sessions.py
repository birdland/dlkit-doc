...
class ObjectiveSearchSession(ObjectiveQuerySession):
    """This session provides methods for searching ``Objective`` objects.
...
class ObjectiveNotificationSession(osid_sessions.OsidSession):
...
class ActivityQuerySession(osid_sessions.OsidSession):
...
class ActivitySearchSession(ActivityQuerySession):
    """This session provides methods for searching ``Activity`` objects.
...
class ActivityNotificationSession(osid_sessions.OsidSession):
...
class ActivitySmartObjectiveBankSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic catalogs.
...
class ProficiencySearchSession(ProficiencyQuerySession):
    """This session provides methods for searching among ``Proficiency`` objects.
...
class ProficiencyNotificationSession(osid_sessions.OsidSession):
...
class ProficiencyObjectiveBankSession(osid_sessions.OsidSession):
...
class ProficiencyObjectiveBankAssignmentSession(osid_sessions.OsidSession):
...
class ProficiencySmartObjectiveBankSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic catalogs.
...
class MyLearningPathSession(osid_sessions.OsidSession):
...
class LearningPathSession(osid_sessions.OsidSession):
    """This session defines methods for finding learning paths through an objective hierarchy based on proficiencies."""
    def get_objective_bank_id(self):
        """Gets the ``ObjectiveBank``  ``Id`` associated with this session.
...
class ObjectiveBankQuerySession(osid_sessions.OsidSession):
...
class ObjectiveBankSearchSession(ObjectiveBankQuerySession):
    """This session provides methods for searching among ``ObjectiveBank`` objects.
...
class ObjectiveBankNotificationSession(osid_sessions.OsidSession):
