...
class IdForm(osid_objects.OsidForm):
    ...
    authority = property(fget=set_authority, fdel=clear_authority)
    ...
    identifier_namespace = property(fget=set_identifier_namespace, fdel=clear_identifier_namespace)
    ...
    identifier_prefix = property(fget=set_identifier_prefix, fdel=clear_identifier_prefix)
    ...
    identifier_suffix = property(fget=set_identifier_suffix, fdel=clear_identifier_suffix)
    ...
    identifier = property(fget=set_identifier, fdel=clear_identifier)
