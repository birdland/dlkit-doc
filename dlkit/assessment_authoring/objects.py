...
class AssessmentPart(osid_objects.OsidObject, osid_markers.Containable, osid_markers.Operable):
...
class AssessmentPartForm(osid_objects.OsidObjectForm, osid_objects.OsidContainableForm, osid_objects.OsidOperableForm):
...
class AssessmentPartList(osid_objects.OsidList):
...
class SequenceRule(osid_objects.OsidRule):
...
class SequenceRuleForm(osid_objects.OsidRuleForm):
...
class SequenceRuleList(osid_objects.OsidList):
...
class SequenceRuleEnabler(osid_objects.OsidEnabler):
...
class SequenceRuleEnablerForm(osid_objects.OsidEnablerForm):
...
class SequenceRuleEnablerFormRecord(osid_objects.OsidRuleForm):
...
class SequenceRuleEnablerList(osid_objects.OsidList):
