...
class AssessmentPartNotificationSession(osid_sessions.OsidSession):
    ...
    def register_for_new_assessment_parts(self):
        ...
        ``AssessmentPartReceiver.newAssessmentPart()`` is invoked when a
    ...
    def register_for_changed_assessment_parts(self):
        ...
        ``AssessmentPartReceiver.changedAssessmentPart()`` is invoked
    ...
    def register_for_changed_assessment_part(self, assessment_part_id):
        ...
        ``ProvisionableReceiver.changedAssessmentPart()`` is invoked
    ...
    def register_for_deleted_assessment_parts(self):
        ...
        ``AssessmentPartReceiver.deletedAssessmentPart()`` is invoked
...
class AssessmentPartBankSession(osid_sessions.OsidSession):
...
class AssessmentPartBankAssignmentSession(osid_sessions.OsidSession):
...
class AssessmentPartSmartBankSession(osid_sessions.OsidSession):
...
class SequenceRuleQuerySession(osid_sessions.OsidSession):
...
class SequenceRuleNotificationSession(osid_sessions.OsidSession):
    ...
    def register_for_new_sequence_rules(self):
        ...
        ``SequenceRuleReceiver.newSequenceRule()`` is invoked when a new
    ...
    def register_for_changed_sequence_rules(self):
        ...
        ``SequenceRuleReceiver.changedSequenceRule()`` is invoked when a
    ...
    def register_for_changed_sequence_rule(self, sequence_rule_id):
        ...
        ``ProvisionableReceiver.changedSequenceRule()`` is invoked when
...
class SequenceRuleBankSession(osid_sessions.OsidSession):
...
class SequenceRuleBankAssignmentSession(osid_sessions.OsidSession):
...
class SequenceRuleSmartBankSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic bank.
...
class SequenceRuleEnablerLookupSession(osid_sessions.OsidSession):
...
class SequenceRuleEnablerQuerySession(osid_sessions.OsidSession):
...
class SequenceRuleEnablerAdminSession(osid_sessions.OsidSession):
...
class SequenceRuleEnablerNotificationSession(osid_sessions.OsidSession):
    ...
    def register_for_new_sequence_rule_enablers(self):
        ...
        ``SequenceRuleEnablerReceiver.newSequenceRuleEnabler()`` is
    ...
    def register_for_changed_sequence_rule_enablers(self):
        ...
        ``SequenceRuleEnablerReceiver.changedSequenceRuleEnabler()`` is
    ...
    def register_for_changed_sequence_rule_enabler(self, sequence_rule_enabler_id):
        ...
        ``ProvisionableReceiver.changedSequenceRuleEnabler()`` is
    ...
    def register_for_deleted_sequence_rule_enablers(self):
        ...
        ``SequenceRuleEnablerReceiver.deletedSequenceRuleEnabler()`` is
...
class SequenceRuleEnablerBankSession(osid_sessions.OsidSession):
...
class SequenceRuleEnablerBankAssignmentSession(osid_sessions.OsidSession):
...
class SequenceRuleEnablerSmartBankSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic bank.
...
class SequenceRuleEnablerRuleLookupSession(osid_sessions.OsidSession):
...
class SequenceRuleEnablerRuleApplicationSession(osid_sessions.OsidSession):
