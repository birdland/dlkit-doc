...
class ResourceSmartBinSession(osid_sessions.OsidSession):
...
class MembershipSession(osid_sessions.OsidSession):
...
class GroupSession(osid_sessions.OsidSession):
...
class GroupAssignmentSession(osid_sessions.OsidSession):
...
class GroupNotificationSession(osid_sessions.OsidSession):
...
class GroupHierarchySession(osid_sessions.OsidSession):
...
class ResourceRelationshipLookupSession(osid_sessions.OsidSession):
...
class ResourceRelationshipQuerySession(osid_sessions.OsidSession):
...
class ResourceRelationshipSearchSession(ResourceRelationshipQuerySession):
    """This session provides methods for searching ``ResourceRelationship`` objects.
...
class ResourceRelationshipAdminSession(osid_sessions.OsidSession):
...
class ResourceRelationshipNotificationSession(osid_sessions.OsidSession):
...
class ResourceRelationshipBinSession(osid_sessions.OsidSession):
...
class ResourceRelationshipBinAssignmentSession(osid_sessions.OsidSession):
...
class ResourceRelationshipSmartBinSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic catalogs.
...
class BinSearchSession(BinQuerySession):
    """This session provides methods for searching among ``Bin`` objects.
...
class BinNotificationSession(osid_sessions.OsidSession):
