...
class ResourceQueryInspector(osid_query_inspectors.OsidObjectQueryInspector):
...
class ResourceRelationshipQueryInspector(osid_query_inspectors.OsidRelationshipQueryInspector):
...
class BinQueryInspector(osid_query_inspectors.OsidCatalogQueryInspector):
