...
class ResourceRelationship(osid_objects.OsidRelationship):
...
class ResourceRelationshipForm(osid_objects.OsidRelationshipForm):
...
class ResourceRelationshipList(osid_objects.OsidList):
...
class Bin(osid_objects.OsidCatalog):
