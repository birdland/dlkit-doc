...
class AuthenticationAcquisitionSession(osid_sessions.OsidSession):
...
class AuthenticationValidationSession(osid_sessions.OsidSession):
...
class TrustLookupSession(osid_sessions.OsidSession):
...
class CircleOfTrustSession(osid_sessions.OsidSession):
