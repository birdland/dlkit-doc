...
class RelationshipQuerySession(osid_sessions.OsidSession):
...
class RelationshipSearchSession(RelationshipQuerySession):
    """This session provides methods for searching among ``Relationship`` objects.
...
class RelationshipNotificationSession(osid_sessions.OsidSession):
...
class RelationshipFamilySession(osid_sessions.OsidSession):
...
class RelationshipFamilyAssignmentSession(osid_sessions.OsidSession):
...
class FamilyQuerySession(osid_sessions.OsidSession):
...
class FamilySearchSession(FamilyQuerySession):
    """This session provides methods for searching ``Family`` objects.
...
class FamilyNotificationSession(osid_sessions.OsidSession):
