...
class RelationshipReceiver(osid_receivers.OsidReceiver):
    """The relationship receiver is the consumer supplied interface for receiving notifications pertaining to new, updated or
        deleted ``Relationship`` objects."""
...
class FamilyReceiver(osid_receivers.OsidReceiver):
    """The family receiver is the consumer supplied interface for receiving notifications pertaining to new, updated or deleted
        ``Family`` objects."""
