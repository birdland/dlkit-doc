...
class AssetSmartRepositorySession(osid_sessions.OsidSession):
...
class AssetTemporalSession(osid_sessions.OsidSession):
...
class AssetTemporalAssignmentSession(osid_sessions.OsidSession):
...
class AssetSpatialSession(osid_sessions.OsidSession):
...
class AssetSpatialAssignmentSession(osid_sessions.OsidSession):
...
class CompositionNotificationSession(osid_sessions.OsidSession):
...
class CompositionSmartRepositorySession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic catalogs.
...
class RepositoryNotificationSession(osid_sessions.OsidSession):
