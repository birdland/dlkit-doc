...
class HierarchySequencingSession(osid_sessions.OsidSession):
...
class HierarchyStructureNotificationSession(osid_sessions.OsidSession):
...
class HierarchyQuerySession(osid_sessions.OsidSession):
...
class HierarchySearchSession(HierarchyQuerySession):
    """This session provides methods for searching among ``Hierarchy`` objects.
...
class HierarchyNotificationSession(osid_sessions.OsidSession):
