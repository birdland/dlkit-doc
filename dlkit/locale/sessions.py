...
class TranslationSession(osid_sessions.OsidSession):
...
class TranslationAdminSession(osid_sessions.OsidSession):
...
class NumericFormattingSession(osid_sessions.OsidSession):
...
class CalendarFormattingSession(osid_sessions.OsidSession):
...
class CurrencyFormattingSession(osid_sessions.OsidSession):
...
class CoordinateFormattingSession(osid_sessions.OsidSession):
...
class UnitConversionSession(osid_sessions.OsidSession):
...
class CurrencyConversionSession(osid_sessions.OsidSession):
...
class CalendarConversionSession(osid_sessions.OsidSession):
...
class CoordinateConversionSession(osid_sessions.OsidSession):
...
class SpatialUnitConversionSession(osid_sessions.OsidSession):
