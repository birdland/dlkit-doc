...
class RatingLookupSession(osid_sessions.OsidSession):
    """This session defines methods for retrieving comments."""
    def get_book_id(self):
        """Gets the ``Book``  ``Id`` associated with this session.
...
class CommentQuerySession(osid_sessions.OsidSession):
...
class CommentSearchSession(CommentQuerySession):
    """This session provides methods for searching ``Comment`` objects.
...
class CommentAdminSession(osid_sessions.OsidSession):
...
class CommentNotificationSession(osid_sessions.OsidSession):
...
class CommentBookSession(osid_sessions.OsidSession):
...
class CommentBookAssignmentSession(osid_sessions.OsidSession):
...
class BookLookupSession(osid_sessions.OsidSession):
...
class BookQuerySession(osid_sessions.OsidSession):
...
class BookSearchSession(BookQuerySession):
    """This session provides methods for searching ``Book`` objects.
...
class BookAdminSession(osid_sessions.OsidSession):
...
class BookNotificationSession(osid_sessions.OsidSession):
...
class BookHierarchySession(osid_sessions.OsidSession):
...
class BookHierarchyDesignSession(osid_sessions.OsidSession):
