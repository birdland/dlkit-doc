...
class OutboundStreamSession(osid_sessions.OsidSession):
...
class InboundStreamSession(osid_sessions.OsidSession):
...
class OutboundMessageSession(osid_sessions.OsidSession):
...
class InboundMessageSession(osid_sessions.OsidSession):
...
class EndpointLookupSession(osid_sessions.OsidSession):
