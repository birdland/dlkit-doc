...
# The following methods are from osid.relationship.FamilyLookupSession
    ...
    def use_comparative_family_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_family_view()
            except AttributeError:
                pass
    ...
    def use_plenary_family_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_family_view()
            except AttributeError:
                pass
    ...
    def get_family(self, *args, **kwargs):
        ...
        return Family(self._provider_manager, self._get_provider_session('family_lookup_session').get_family(*args, **kwargs), self._proxy)
    ...
    def get_families_by_ids(self, *args, **kwargs):
        ...
        cat_list = []
        for cat in catalogs:
            cat_list.append(Family(self._provider_manager, cat, self._proxy))
...
# The following methods are from osid.relationship.FamilyAdminSession
    ...
    def create_family(self, *args, **kwargs):
        ...
        return Family(self._provider_manager, self._get_provider_session('family_admin_session').create_family(*args, **kwargs), self._proxy)
    ...
    def update_family(self, *args, **kwargs):
        ...
        return Family(self._provider_manager, self._get_provider_session('family_admin_session').update_family(*args, **kwargs), self._proxy)
...
# The following methods are from osid.relationship.RelationshipLookupSession
    ...
    def use_comparative_relationship_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_relationship_view()
            except AttributeError:
                pass
    ...
    def use_plenary_relationship_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_relationship_view()
            except AttributeError:
                pass
    ...
    def use_federated_family_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_federated_family_view()
            except AttributeError:
                pass
    ...
    def use_isolated_family_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_isolated_family_view()
            except AttributeError:
                pass
