...
# The following methods are from osid.repository.AssetRepositorySession
    ...
    def use_comparative_repository_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_repository_view()
            except AttributeError:
                pass
    ...
    def use_plenary_repository_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_repository_view()
            except AttributeError:
                pass
    ...
    def get_repositories_by_asset(self, *args, **kwargs):
        ...
        return self._get_provider_session('asset_repository_session').get_repositories_by_asset(*args, **kwargs)
...
# The following methods are from osid.repository.CompositionRepositorySession
    ...
    def get_repositories_by_composition(self, *args, **kwargs):
        ...
        # Implemented from kitosid template for -
        # osid.resource.ResourceBinSession.get_bins_by_resource
        return self._get_provider_session('composition_repository_session').get_repositories_by_composition(*args, **kwargs)
...
# The following methods are from osid.repository.RepositoryLookupSession
    ...
    def get_repository(self, *args, **kwargs):
        ...
        return Repository(self._provider_manager, self._get_provider_session('repository_lookup_session').get_repository(*args, **kwargs), self._proxy)
    ...
    def get_repositories_by_ids(self, *args, **kwargs):
        ...
        cat_list = []
        for cat in catalogs:
            cat_list.append(Repository(self._provider_manager, cat, self._proxy))
...
# The following methods are from osid.repository.RepositoryAdminSession
    ...
    def create_repository(self, *args, **kwargs):
        ...
        return Repository(self._provider_manager, self._get_provider_session('repository_admin_session').create_repository(*args, **kwargs), self._proxy)
    ...
    def update_repository(self, *args, **kwargs):
        ...
        return Repository(self._provider_manager, self._get_provider_session('repository_admin_session').update_repository(*args, **kwargs), self._proxy)
...
# The following methods are from osid.repository.AssetLookupSession
    ...
    def use_comparative_asset_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_asset_view()
            except AttributeError:
                pass
    ...
    def use_plenary_asset_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_asset_view()
            except AttributeError:
                pass
    ...
    def use_federated_repository_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_federated_repository_view()
            except AttributeError:
                pass
    ...
    def use_isolated_repository_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_isolated_repository_view()
            except AttributeError:
                pass
...
# The following methods are from osid.repository.AssetCompositionSession
    ...
    def use_comparative_asset_composition_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_asset_composition_view()
            except AttributeError:
                pass
    ...
    def use_plenary_asset_composition_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_asset_composition_view()
            except AttributeError:
                pass
...
# The following methods are from osid.repository.CompositionLookupSession
    ...
    def use_comparative_composition_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_composition_view()
            except AttributeError:
                pass
    ...
    def use_plenary_composition_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_composition_view()
            except AttributeError:
                pass
