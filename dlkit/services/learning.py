...
# The following methods are from osid.learning.ObjectiveObjectiveBankSession
    ...
    def use_comparative_objective_bank_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_objective_bank_view()
            except AttributeError:
                pass
    ...
    def use_plenary_objective_bank_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_objective_bank_view()
            except AttributeError:
                pass
    ...
    def get_objective_banks_by_objective(self, *args, **kwargs):
        ...
        return self._get_provider_session('objective_objective_bank_session').get_objective_banks_by_objective(*args, **kwargs)
...
# The following methods are from osid.learning.ActivityObjectiveBankSession
    ...
    def get_objective_banks_by_activity(self, *args, **kwargs):
        ...
        # Implemented from kitosid template for -
        # osid.resource.ResourceBinSession.get_bins_by_resource
        return self._get_provider_session('activity_objective_bank_session').get_objective_banks_by_activity(*args, **kwargs)
...
# The following methods are from osid.learning.ObjectiveBankLookupSession
    ...
    def get_objective_bank(self, *args, **kwargs):
        ...
        return ObjectiveBank(self._provider_manager, self._get_provider_session('objective_bank_lookup_session').get_objective_bank(*args, **kwargs), self._proxy)
    ...
    def get_objective_banks_by_ids(self, *args, **kwargs):
        ...
        cat_list = []
        for cat in catalogs:
            cat_list.append(ObjectiveBank(self._provider_manager, cat, self._proxy))
...
# The following methods are from osid.learning.ObjectiveBankAdminSession
    ...
    def create_objective_bank(self, *args, **kwargs):
        ...
        return ObjectiveBank(self._provider_manager, self._get_provider_session('objective_bank_admin_session').create_objective_bank(*args, **kwargs), self._proxy)
    ...
    def update_objective_bank(self, *args, **kwargs):
        ...
        return ObjectiveBank(self._provider_manager, self._get_provider_session('objective_bank_admin_session').update_objective_bank(*args, **kwargs), self._proxy)
...
# The following methods are from osid.learning.ObjectiveLookupSession
    ...
    def use_comparative_objective_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_objective_view()
            except AttributeError:
                pass
    ...
    def use_plenary_objective_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_objective_view()
            except AttributeError:
                pass
    ...
    def use_federated_objective_bank_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_federated_objective_bank_view()
            except AttributeError:
                pass
    ...
    def use_isolated_objective_bank_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_isolated_objective_bank_view()
            except AttributeError:
                pass
...
# The following methods are from osid.learning.ActivityLookupSession
    ...
    def use_comparative_activity_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_activity_view()
            except AttributeError:
                pass
    ...
    def use_plenary_activity_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_activity_view()
            except AttributeError:
                pass
...
# The following methods are from osid.learning.ProficiencyLookupSession
    ...
    def use_comparative_proficiency_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_proficiency_view()
            except AttributeError:
                pass
    ...
    def use_plenary_proficiency_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_proficiency_view()
            except AttributeError:
                pass
