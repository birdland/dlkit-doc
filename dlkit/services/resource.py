...
# The following methods are from osid.resource.ResourceBinSession
    ...
    def use_comparative_bin_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_bin_view()
            except AttributeError:
                pass
    ...
    def use_plenary_bin_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_bin_view()
            except AttributeError:
                pass
    ...
    def get_bins_by_resource(self, *args, **kwargs):
        ...
        return self._get_provider_session('resource_bin_session').get_bins_by_resource(*args, **kwargs)
...
# The following methods are from osid.resource.BinLookupSession
    ...
    def get_bin(self, *args, **kwargs):
        ...
        return Bin(self._provider_manager, self._get_provider_session('bin_lookup_session').get_bin(*args, **kwargs), self._proxy)
    ...
    def get_bins_by_ids(self, *args, **kwargs):
        ...
        cat_list = []
        for cat in catalogs:
            cat_list.append(Bin(self._provider_manager, cat, self._proxy))
...
# The following methods are from osid.resource.BinAdminSession
    ...
    def create_bin(self, *args, **kwargs):
        ...
        return Bin(self._provider_manager, self._get_provider_session('bin_admin_session').create_bin(*args, **kwargs), self._proxy)
    ...
    def update_bin(self, *args, **kwargs):
        ...
        return Bin(self._provider_manager, self._get_provider_session('bin_admin_session').update_bin(*args, **kwargs), self._proxy)
...
# The following methods are from osid.resource.ResourceLookupSession
    ...
    def use_comparative_resource_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_resource_view()
            except AttributeError:
                pass
    ...
    def use_plenary_resource_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_resource_view()
            except AttributeError:
                pass
    ...
    def use_federated_bin_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_federated_bin_view()
            except AttributeError:
                pass
    ...
    def use_isolated_bin_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_isolated_bin_view()
            except AttributeError:
                pass
...
# The following methods are from osid.resource.ResourceAgentSession
    ...
    def use_comparative_agent_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_agent_view()
            except AttributeError:
                pass
    ...
    def use_plenary_agent_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_agent_view()
            except AttributeError:
                pass
