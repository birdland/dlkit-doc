...
# The following methods are from osid.grading.GradebookLookupSession
    ...
    def use_comparative_gradebook_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_gradebook_view()
            except AttributeError:
                pass
    ...
    def use_plenary_gradebook_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_gradebook_view()
            except AttributeError:
                pass
    ...
    def get_gradebook(self, *args, **kwargs):
        ...
        return Gradebook(self._provider_manager, self._get_provider_session('gradebook_lookup_session').get_gradebook(*args, **kwargs), self._proxy)
    ...
    def get_gradebooks_by_ids(self, *args, **kwargs):
        ...
        cat_list = []
        for cat in catalogs:
            cat_list.append(Gradebook(self._provider_manager, cat, self._proxy))
...
# The following methods are from osid.grading.GradebookAdminSession
    ...
    def create_gradebook(self, *args, **kwargs):
        ...
        return Gradebook(self._provider_manager, self._get_provider_session('gradebook_admin_session').create_gradebook(*args, **kwargs), self._proxy)
    ...
    def update_gradebook(self, *args, **kwargs):
        ...
        return Gradebook(self._provider_manager, self._get_provider_session('gradebook_admin_session').update_gradebook(*args, **kwargs), self._proxy)
...
# The following methods are from osid.grading.GradeSystemLookupSession
    ...
    def use_comparative_grade_system_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_grade_system_view()
            except AttributeError:
                pass
    ...
    def use_plenary_grade_system_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_grade_system_view()
            except AttributeError:
                pass
    ...
    def use_federated_gradebook_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_federated_gradebook_view()
            except AttributeError:
                pass
    ...
    def use_isolated_gradebook_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_isolated_gradebook_view()
            except AttributeError:
                pass
...
# The following methods are from osid.grading.GradeEntryLookupSession
    ...
    def use_comparative_grade_entry_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_grade_entry_view()
            except AttributeError:
                pass
    ...
    def use_plenary_grade_entry_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_grade_entry_view()
            except AttributeError:
                pass
...
# The following methods are from osid.grading.GradebookColumnLookupSession
    ...
    def use_comparative_gradebook_column_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_comparative_gradebook_column_view()
            except AttributeError:
                pass
    ...
    def use_plenary_gradebook_column_view(self):
        ...
        for session in self._provider_sessions:
            try:
                self._provider_sessions[session].use_plenary_gradebook_column_view()
            except AttributeError:
                pass
