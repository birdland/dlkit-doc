...
class FunctionSearch(osid_searches.OsidSearch):
...
class FunctionSearchResults(osid_searches.OsidSearchResults):
    """This interface provides a means to capture results of a search."""
...
class QualifierSearch(osid_searches.OsidSearch):
...
class QualifierSearchResults(osid_searches.OsidSearchResults):
    """This interface provides a means to capture results of a search."""
