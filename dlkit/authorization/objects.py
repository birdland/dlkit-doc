...
class Function(osid_objects.OsidRule):
...
class FunctionForm(osid_objects.OsidRuleForm):
...
class FunctionList(osid_objects.OsidList):
...
class Qualifier(osid_objects.OsidObject, osid_markers.Federateable):
...
class QualifierForm(osid_objects.OsidObjectForm, osid_objects.OsidFederateableForm):
...
class QualifierList(osid_objects.OsidList):
...
class QualifierNode(osid_objects.OsidNode):
...
class QualifierNodeList(osid_objects.OsidList):
...
class Vault(osid_objects.OsidCatalog):
