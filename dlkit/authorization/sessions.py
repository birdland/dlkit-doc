...
class AuthorizationSearchSession(AuthorizationQuerySession):
    """This session provides methods for searching ``Authorization`` objects.
...
class AuthorizationNotificationSession(osid_sessions.OsidSession):
...
class AuthorizationVaultSession(osid_sessions.OsidSession):
...
class AuthorizationVaultAssignmentSession(osid_sessions.OsidSession):
...
class AuthorizationSmartVaultSession(osid_sessions.OsidSession):
...
class FunctionLookupSession(osid_sessions.OsidSession):
...
class FunctionQuerySession(osid_sessions.OsidSession):
...
class FunctionSearchSession(FunctionQuerySession):
    """This session provides methods for searching ``Function`` objects.
...
class FunctionAdminSession(osid_sessions.OsidSession):
...
class FunctionNotificationSession(osid_sessions.OsidSession):
...
class FunctionVaultSession(osid_sessions.OsidSession):
...
class FunctionVaultAssignmentSession(osid_sessions.OsidSession):
...
class FunctionSmartVaultSession(osid_sessions.OsidSession):
    """This session manages queries and sequencing to create "smart" dynamic catalogs.
...
class QualifierLookupSession(osid_sessions.OsidSession):
...
class QualifierQuerySession(osid_sessions.OsidSession):
...
class QualifierSearchSession(QualifierQuerySession):
    """This session provides methods for searching among ``Qualifier`` objects.
...
class QualifierAdminSession(osid_sessions.OsidSession):
...
class QualifierNotificationSession(osid_sessions.OsidSession):
...
class QualifierHierarchySession(osid_sessions.OsidSession):
...
class QualifierHierarchyDesignSession(osid_sessions.OsidSession):
...
class QualifierVaultSession(osid_sessions.OsidSession):
...
class QualifierVaultAssignmentSession(osid_sessions.OsidSession):
...
class VaultSearchSession(VaultQuerySession):
    """This session provides methods for searching among ``Vault`` objects.
...
class VaultNotificationSession(osid_sessions.OsidSession):
...
class VaultHierarchySession(osid_sessions.OsidSession):
...
class VaultHierarchyDesignSession(osid_sessions.OsidSession):
